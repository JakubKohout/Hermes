 ...
 */
class Version20140112224831 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE Type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Catering (id INT AUTO_INCREMENT NOT NULL, trip_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_8008C0B6A5BC2E0E (trip_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Country (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE Office (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Contract (id INT AUTO_INCREMENT NOT NULL, office_id INT NOT NULL, employee_id INT NOT NULL, trip_id INT NOT NULL, customers_id INT NOT NULL, signed DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_10F94A0FFFA0C224 (office_id), INDEX IDX_10F94A0F8C03F15C (employee_id), INDEX IDX_10F94A0FA5BC2E0E (trip_id), INDEX IDX_10F94A0FC3568B40 (customers_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE Customer (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, personal_number VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Participant (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, personal_number VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Employee (id INT AUTO_INCREMENT NOT NULL, office_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_A4E917F7FFA0C224 (office_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE Transport (id INT AUTO_INCREMENT NOT NULL, trip_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, type LONGTEXT DEFAULT NULL COMMENT '(DC2Type:simple_array)', INDEX IDX_E45AA38DA5BC2E0E (trip_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Trip (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, category_id INT NOT NULL, country_id INT NOT NULL, INDEX IDX_D6645A05C54C8C93 (type_id), INDEX IDX_D6645A0512469DE2 (category_id), INDEX IDX_D6645A05F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE contract_participant DROP FOREIGN KEY FK_9534B2DC24584564");
        ...
        $this->addSql("ALTER TABLE contract_participant DROP FOREIGN KEY FK_9534B2DC838709D5");
        $this->addSql("ALTER TABLE Contract DROP FOREIGN KEY FK_10F94A0F8C03F15C");
        $this->addSql("ALTER TABLE employee_role DROP FOREIGN KEY FK_E2B0C02D8520A30B");
